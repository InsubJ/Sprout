 ...
 */
export function computeBlossomFace(isWithered: boolean, isCompleted: boolean, isFlawless: boolean): BlossomFace {
    if (isWithered) {
        return {
 ...
 * Precondition: none.
 */
export function computeUmbrella(handleX: number, handleY: number, isWithered: boolean): UmbrellaGeometry {
