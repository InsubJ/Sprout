 ...
 */
export function computeDogEars(headCenterX: number, headCenterY: number, headRadius: number, isWithered: boolean): DogEars {
 ...
 */
export function computeDogTail(baseX: number, baseY: number, tailLength: number, isWithered: boolean): string {
    if (isWithered) {
 ...
 */
export function computeDogFace(isWithered: boolean, isCompleted: boolean, isFlawless: boolean): DogFace {
    if (isWithered) {
