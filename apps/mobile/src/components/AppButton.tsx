  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        styles.base,
        styles[tone],
        tone === "quiet" && { backgroundColor: theme.elevated, borderWidth: 1, borderColor: theme.border },
    ...
    >
      <Text style={[styles.label, tone === "quiet" && styles.quietLabel, tone === "quiet" && { color: theme.text }]}>
        {label}
      </Text>
    </Pressable>
  );
