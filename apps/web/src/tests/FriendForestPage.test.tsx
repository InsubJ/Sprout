...
describe('FriendForestPage Component & Hook', () => {
  ...
  describe('Connected Forest Content Rendering', () => {
    it('renders stats overview and public trees correctly when connected', () => {
      ...
      // Header display name formatted as display_name's Sanctuary
      expect(document.querySelector('[data-testid="profile-display-name"]')?.textContent).toBe("Alice Cooper's Sanctuary");
